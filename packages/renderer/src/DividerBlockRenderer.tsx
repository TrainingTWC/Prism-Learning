...
export function DividerBlockRenderer({ block }: Props) {
  ...
  if (style === 'space') {
    return <div className="prism-divider" style={{ margin: '3rem 0' }} />;
  }

  if (style === 'dots') {
    return (
      <div className="prism-divider" style={{ margin: '2rem 0', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem' }}>
  ...
  if (payload.label) {
    return (
      <div className="prism-divider" style={{ margin: '2rem 0', display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
  ...
  return <hr className="prism-divider" style={{ margin: '2rem 0', border: 0, borderTop: '1px solid #e2e8f0' }} />;
}
