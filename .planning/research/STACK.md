...
**Domain:** Rise-360-style block-based learning module authoring tool (Vite + React SPA, Convex backend, Cloudflare Pages/Workers/R2, SCORM 1.2 export)
**Researched:** 2026-05-27
**Confidence:** HIGH for locked stack and well-trodden libraries (Tiptap, shadcn/ui, scorm-again, JSZip, Vitest, Playwright). MEDIUM for state mgmt and router choices (multiple reasonable options).
...
This document recommends libraries that fill in *around* the locked stack.
...
**Client-side vs Worker-side zipping decision:**
...
npm install @tiptap/extension-link @tiptap/extension-placeholder @tiptap/extension-image
npm install @dnd-kit/core @dnd-kit/sortable @dnd-kit/utilities
npm install scorm-again jszip
...
**If realtime collab needs *true* concurrent text editing in a single rich-text block (not v1):**
...
**If exported module sizes routinely exceed ~20 MB:**
...
**If quiz block scoring rules expand (multi-correct, weighting, partial credit) and SCORM 1.2's flat score model becomes limiting:**
- Reconsider SCORM 2004 — `scorm-again` already supports it; the work is in `imsmanifest.xml` rewrites, not the JS API

**If the team grows beyond ~10 authors or signups become public:**
...
---
*Stack research for: Rise-360-style learning module authoring tool (Prism Learning)*
*Researched: 2026-05-27*
