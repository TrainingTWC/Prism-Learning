...
**Last activity:** 2026-08-03 - Completed quick task 260803-kvg: fixed Learner Preview phone/tablet bezel dead-space bug (self-start flex fix in PreviewPage.tsx), deployed to prod (pending human verification of the fix).
