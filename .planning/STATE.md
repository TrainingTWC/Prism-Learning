...
**Last activity:** 2026-08-14 - Completed quick task 260814-g4m: quiz blocks no longer reveal correct/incorrect per question, learner advances freely, final module-wide score drives completion modal + SCORM lesson_status (pending human verification + prod deploy).
